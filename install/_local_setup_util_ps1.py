...
def _append_unique_value(name, value):
    ...
    if name not in env_state:
        if os.environ.get(name):
            ...
            env_state[name] = set()
    # append even if the variable has not been set yet, in case a shell
...
def _prepend_unique_value(name, value):
    ...
    if name not in env_state:
        if os.environ.get(name):
            ...
            env_state[name] = set()
    # prepend even if the variable has not been set yet, in case a
    # same variable without the knowledge of this Python script.
    # later _remove_ending_separators() will cleanup any unintentional
...
def _remove_ending_separators():
    ...
    for name in env_state:
        # skip variables that already had values before this script start
